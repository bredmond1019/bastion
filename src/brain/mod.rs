...
///
/// Thin I/O shell: discovers and reads markdown files under `root`, builds the
/// OKF knowledge graph, runs the requested query, and prints a greppable report.
///
...
pub fn run(query: BrainQuery, root: PathBuf) -> Result<()> {
