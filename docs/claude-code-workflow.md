...
bastion new claude-bastion --dir ~/agentic-portfolio
...
```bash
bastion new claude-rag   --dir ~/agentic-portfolio
bastion new claude-learn --dir ~/agentic-portfolio
...
bastion new wf --dir ~/agentic-portfolio
