---
type: Guideline
title: "serve-api contract v0.37"
...
## 26. Operator-notification transport (v0.27, `BA.18.B`; acknowledgement contract v0.29, `ticket-telegram-answer-callback`; trait re-homed to `engine_core::operator` v0.37, `BA.21.A`)
