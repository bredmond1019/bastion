...
| Block C | Structural code navigation (code-as-graph) | Q | Done | tree-sitter symbol/ref extraction; code-as-graph layer reusing BrainGraph; `bastion code --def/--refs/--dependents` CLI surface. Code-review: 8 findings, all resolved (4 inline + 4 deferred: qualified IDs D10, grouped use imports, OnceLock hoisting, single parse). 588 tests pass. PASS 2026-06-26. |
